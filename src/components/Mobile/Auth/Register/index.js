                ...
                <div className="bg-white">
                    <form onSubmit={this.handleRegister} id="registerForm">
                        <div className="form-group px-15 pt-30">
                            ...
                            <label className="col-12 edit-address-input-label">
                                Second Name
                                {this.validator.message("second_name", this.state.second_name, "required|string")}
                            </label>
                            <div className="col-md-9 pb-5">
                                <input
                                    type="text"
                            ...
                            <label className="col-md-12 edit-address-input-label">
                                Date of Birth
                                {this.validator.message("date_of_birth", this.state.date_of_birth, "required")}
                            </label>
                            <div className="col-md-9">
                                <input type="date" name="date_of_birth" className="form-control edit-address-input"
                                       onChange={this.handleInputChange}/>
                            </div>
                            ...
                            <label className="col-12 edit-address-input-label mt-3">
