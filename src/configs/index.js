...
export const REGISTER_WINES_AND_SPIRITS = WEBSITE_URL + "/public/auth/login/?usr=wines_and_spirits";
export const REGISTER_DELIVERY_GUY = WEBSITE_URL + "/public/auth/login/?usr=delivery_guy";
...
export const MPESA_PAYMENT_URL = WEBSITE_URL + "/public/api/payment/process-m-pesa"
export const MPESA_STK_PUSH_QUERY_URL = WEBSITE_URL + "/public/api/payment/stk-push-status"
