    ...
    <div class="d-md-none">
        ...
        <div class="dropdown-menu dropdown-menu-right" id="navbar-mobile">
            <a href="{{ route('logout') }}" class="dropdown-item"><i
                        class="icon-switch2"></i> {{ __('storeDashboard.navLogout') }}</a>
            @role("Store Owner")
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a href="javascript:void(0)"
                       class="navbar-nav-link dropdown-toggle {{ Request::is('admin/items')  || Request::is('admin/addons') ? 'active' : '' }}"
                        ...
                        <div class="row extra-menu">
                            <div class="col-md-6">
                                ...
                                <a href="{{ route("admin.modules") }}"
                                   class="dropdown-item {{ Request::is('admin/modules') ? 'active' : '' }}">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a href="{{ route('restaurant.dashboard') }}" class="dropdown-item">
