...
@section("content")
        ...
        <div class="card mb-0">
            <div class="card-body">
                ...
                <div class="content d-flex justify-content-center align-items-center mt-3">
                    <button class="btn btn-lg btn-registerBtn mr-2 regButtonDelivery" type="button">Register for
                        Delivery
                    </button>
                    <button class="btn btn-lg btn-registerBtn regButtonResOwn" type="button">
                        Bars and Wines and Spirits
                    </button>
                </div>
            </div>
        </div>
    </form>
    <form class="registration-form py-5 hidden" action="{{ route('registerRestaurantDelivery') }}" method="POST"
          id="regForm" style="margin: 0 auto 20px auto;">
        ...
        <div class="card mb-0">
            <div class="card-body">
                ...
                <hr>
                <label><strong>Owner Information</strong></label>
                <div class="form-group form-group-feedback form-group-feedback-left">
                ...
                <label for="" class="col-md-12"><strong>Gender</strong></label>
                ...
                <div class="form-group form-group-feedback form-group-feedback-left">
                    <input type="number" class="form-control" placeholder="Phone number" name="phone" min="8"
                           required="required">
                    <div class="form-control-feedback">
    ...
    <script>
        $('.regButtonDelivery').click(function (event) {
            ...
            $('.business-details').removeClass('d-block').addClass('d-none');
    ...
    <script>
        $(document).ready(function () {
            if (findGetParameter('usr') === 'delivery_guy') {
                $('.regButtonDelivery').click();
            } else if (findGetParameter('usr') === 'wines_and_spirits') {
                $('.regButtonResOwn').click();
            }
        })
    ...
    @if(Session::has('delivery_register_message'))
        <div class="d-flex justify-content-center align-items-center mt-3">
            <div class="delivery-msg p-3"><b>SUCCESS!!!</b> You can now login to the delivery application using your
                phone.
            </div>
        </div>
    @endif
