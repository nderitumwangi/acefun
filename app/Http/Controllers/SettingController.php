    ...
    public function getSettings()
    {
        ...
        if (Cache::has('app-settings')) {
            ...
            $settings = Setting::whereNotIn('key',
                [
                    'categoriesFiltersText', 'categoriesNoRestaurantsFoundText', 'exlporeByRestaurantText',
                    'setNewPasswordButtonText', 'newPasswordLabelText', 'enterNewPasswordText',
                    'dontHaveResetOtpButtonText', 'verifyResetOtpButtonText', 'enterResetOtpMessageText',
                    'alreadyHaveResetOtpButtonText', 'sendOtpOnEmailButtonText', 'resetPasswordPageSubTitle',
                    'resetPasswordPageTitle', 'invalidOtpErrorMessage', 'userNotFoundErrorMessage', 'updatingMessage', 'exploreNoResults',
                    'stripeSecretKey', 'paystackPrivateKey', 'twilioSid', 'twilioAccessToken', 'twilioServiceId',
                    'twilioFromPhone', 'minPayout', 'otpMessage', 'smsRestaurantNotify', 'smsDeliveryNotify',
                    'defaultSmsRestaurantMsg', 'smsRestOrderValue', 'smsOrderNotify', 'defaultSmsDeliveryMsg',
                    'restaurantNotificationAudioTrack', 'restaurantNewOrderRefreshRate', 'firebaseSecret',
                    'razorpayKeySecret', 'deliveryAcceptTimeThreshold', 'restaurantAcceptTimeThreshold', 'enDevMode',
                    'deliveryGuyCommissionFrom', 'itemPercentageDiscountText', 'itemsMenuButtonText',
                    'itemSearchPlaceholder', 'itemSearchNoResultText', 'itemSearchText', 'deliveryCommissionMessage',
                    'deliveryCompletedText', 'deliveryOnGoingText', 'deliveryEarningsText', 'deliveryFooterAccount',
                    'deliveryFooterAcceptedTitle', 'deliveryFooterNewTitle', 'changeLanguageText',
                    'searchAtleastThreeCharsMsg', 'orderCancelledText', 'socialLoginOrText', 'deliveryCashOnDelivery',
                    'deliveryOrderPlacedText', 'cancelOrderMainButton', 'cancelGoBackBtn', 'yesCancelOrderBtn',
                    'orderCancellationConfirmationText', 'exploreItemsText', 'exploreRestautantsText',
                    'notAcceptingOrdersMsg', 'yourLocationText', 'gpsAccessNotGrantedMsg', 'useCurrentLocationText',
                    'addressDoesnotDeliverToText', 'cartRestaurantNotOperational', 'willNotBeRefundedText',
                    'willBeRefundedText', 'cartCouponOffText', 'deliveryGuyNewOrderNotificationMsgSub',
                    'deliveryGuyNewOrderNotificationMsg', 'restaurantNewOrderNotificationMsgSub',
                    'restaurantNewOrderNotificationMsg', 'walletRedeemBtnText', 'orderPartialRefundWalletComment',
                    'orderRefundWalletComment', 'orderPartialPaymentWalletComment', 'orderPaymentWalletComment',
                    'payFullWithWalletText', 'willbeDeductedText', 'payPartialWithWalletText', 'walletWithdrawText',
                    'walletDepositText', 'noWalletTransactionsText', 'accountMyWallet', 'showLessButtonText',
                    'showMoreButtonText', 'certificateCodeText', 'pureVegText', 'readyForPickupStatusText',
                    'canceledStatusText', 'deliveredStatusText', 'orderPickedUpStatusText',
                    'deliveryGuyAssignedStatusText', 'preparingOrderStatusText', 'orderPlacedStatusText',
                    'trackOrderText', 'ongoingOrderMsg', 'itemsRemovedMsg', 'taxText', 'deliveryOrdersRefreshBtn',
                    'allowLocationAccessMessage', 'checkoutRazorpaySubText', 'checkoutRazorpayText', 'callNowButton',
                    'deliveryGuyAfterName', 'vehicleText', 'selectedSelfPickupMessage', 'noRestaurantMessage',
                    'deliveryTypeSelfPickup', 'deliveryTypeDelivery', 'runningOrderReadyForPickupSub',
                    'runningOrderReadyForPickup', 'emailPassDonotMatch', 'socialWelcomeText', 'verifyOtpBtnText',
                    'resendOtpCountdownMsg', 'resendOtpMsg', 'otpSentMsg', 'invalidOtpMsg', 'enterPhoneToVerify',
                    'emailPhoneAlreadyRegistered', 'minimumLengthValidationMessage', 'phoneValidationMsg',
                    'emailValidationMsg', 'nameValidationMsg', 'fieldValidationMsg', 'paystackPayText',
                    'customizationDoneBtnText', 'customizableItemText', 'customizationHeading',
                    'deliveryLogoutConfirmation', 'deliveryLogoutDelivery', 'deliveryAlreadyAccepted',
                    'deliveryInvalidDeliveryPin', 'deliveryOrderCompletedButton', 'deliveryDeliveredButton',
                    'deliveryPickedUpButton', 'deliveryAcceptOrderButton', 'deliveryDeliveryPinPlaceholder',
                    'deliveryOnlinePayment', 'deliveryDeliveryAddress', 'deliveryGetDirectionButton',
                    'deliveryRestaurantAddress', 'deliveryOrderItems', 'deliveryWelcomeMessage',
                    'deliveryAcceptedOrdersTitle', 'deliveryNewOrdersTitle', 'restaurantFeaturedText',
                    'gdprConfirmButton', 'gdprMessage', 'runningOrderDeliveredSub', 'runningOrderDelivered',
                    'deliveryNoNewOrders', 'deliveryNoOrdersAccepted', 'runningOrderDeliveryPin', 'desktopFooterAddress',
                    'desktopFooterSocialHeader', 'desktopAchievementFourSub', 'desktopAchievementFourTitle', 'desktopAchievementThreeSub',
                    'desktopAchievementThreeTitle', 'desktopAchievementTwoSub', 'desktopAchievementTwoTitle', 'desktopAchievementOneSub',
                    'desktopAchievementOneTitle', 'desktopUseAppButton', 'desktopSubHeading', 'desktopHeading', 'accountMyAccount', 'regsiterAlreadyHaveAccount',
                    'loginDontHaveAccount', 'firstScreenRegisterBtn', 'registerRegisterSubTitle', 'registerRegisterTitle', 'registerErrorMessage',
                    'loginLoginNameLabel', 'loginLoginPhoneLabel', 'checkoutCodSubText', 'checkoutCodText', 'checkoutStripeSubText', 'checkoutStripeText',
                    'checkoutPaymentInProcess', 'cartSetYourAddress', 'cartToPayText', 'cartCouponText', 'cartDeliveryCharges', 'cartRestaurantCharges',
                    'cartItemTotalText', 'cartBillDetailsText', 'cartItemsInCartText', 'floatCartViewCartText', 'floatCartItemsText', 'itemsPageRecommendedText',
                    'homePageForTwoText', 'homePageMinsText', 'loginLoginPasswordLabel', 'loginLoginEmailLabel', 'loginLoginSubTitle', 'loginLoginTitle',
                    'pleaseWaitText', 'loginErrorMessage', 'firstScreenLoginBtn', 'firstScreenWelcomeMessage', 'runningOrderCanceledSub',
                    'runningOrderCanceledTitle', 'runningOrderDeliveryAssignedSub', 'runningOrderDeliveryAssignedTitle', 'checkoutSelectPayment',
                    'checkoutPaymentListTitle', 'orderTextTotal', 'noOrdersText', 'runningOrderRefreshButton', 'runningOrderOnwaySub',
                    'runningOrderOnwayTitle', 'runningOrderPreparingSub', 'runningOrderPreparingTitle', 'runningOrderPlacedSub', 'runningOrderPlacedTitle',
                    'checkoutPlaceOrder', 'checkoutPageTitle', 'cartPageTitle', 'cartSetAddressText', 'noAddressText', 'deleteAddressText', 'editAddressText',
                    'cartSuggestionPlaceholder', 'cartInvalidCoupon', 'cartApplyCoupon', 'addressTagPlaceholder', 'editAddressTag', 'editAddressLandmark',
                    'editAddressHouse', 'editAddressAddress', 'buttonSaveAddress', 'buttonNewAddress', 'cartChangeLocation', 'cartDeliverTo',
                    'cartLoginButtonText', 'cartLoginSubHeader', 'cartLoginHeader', 'cartMakePayment', 'accountLogout', 'accountHelpFaq', 'accountMyOrders',
                    'accountManageAddress', 'restaurantSearchPlaceholder', 'cartEmptyText', 'newBadgeText', 'popularBadgeText', 'recommendedBadgeText',
                    'searchPopularPlaces', 'searchAreaPlaceholder', 'restaurantCountText', 'footerAccount', 'footerCart', 'footerExplore', 'footerNearme',
                    'firstScreenLoginText', 'firstScreenSetupLocation', 'firstScreenSubHeading', 'firstScreenHeading', 'registrationPolicyMessage',
                    'locationSavedAddresses', 'restaurantMinOrderMessage', 'footerAlerts', 'markAllAlertReadText', 'noNewAlertsText', 'mail_host', 'mail_port',
                    'mail_username', 'mail_password', 'mail_encryption', 'sendgrid_api_key', 'mail_driver', 'cartItemNotAvailable', 'cartRemoveItemButton',
                    'deliveryTotalEarningsText', 'deliveryUsePhoneToAccessMsg', 'restaurantNotActiveMsg', 'uploadImageQuality', 'msg91SenderId',
                    'msg91AuthKey', 'sendEmailFromEmailName', 'sendEmailFromEmailAddress', 'mapApiKey', 'firebaseSDKSnippet', 'deliveryMaxOrderReachedMsg',
                    'chooseAvatarText', 'customCartMessage', 'customHomeMessage', 'inAppCloseButton', 'inAppOpenLinkButton', 'iOSPWAPopupTitle',
                    'iOSPWAPopupBody', 'iOSPWAPopupShareButtonLabel', 'iOSPWAPopupAddButtonLabel', 'iOSPWAPopupCloseButtonLabel', 'offlineTitleMessage',
                    'offlineSubTitleMessage'])->get(['key', 'value']);
