...
class RestaurantOwnerController extends Controller
{
    ...
    public function saveNewRestaurant(Request $request)
    {
        ...
        isset($request->till_number) ? $restaurant->till_number = $request->till_number : null;
        isset($request->business_type) ? $restaurant->business_type = $request->business_type : null;
    ...
    public function items()
    {
        ...
        $items = Item::whereIn('restaurant_id', $restaurantIds)
            ->orderBy('id', 'DESC')
            ->with('item_category', 'restaurant', 'item')
            ->paginate(20);
    ...
    public function saveNewItem(Request $request)
    {
        ...
        $item->item_id = $request->get('temp_item');
